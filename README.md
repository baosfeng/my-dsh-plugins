...
| [dsh-my-guard](plugins/dsh-my-guard/README.md)                                     | 0.1.5  | 安全护栏：破坏性命令执行前拦截、安装前投毒扫描、提示注入检测 + 告警面板                  |
...
| [dsh-shared](plugins/dsh-shared/README.md)                                         | 0.1.4  | 共享工具包：多插件共用的 server 端工具（信任围栏 / HTTP JSON / 配置持久化 / 原子写）     |
