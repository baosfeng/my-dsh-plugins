...
function optionArgsOf(cmd: string): Set<string> {
 ...
 */
export function positionalArgs(args: BashToken[], optionArgs?: Set<string>): BashToken[] {
  const paths: BashToken[] = []
 ...
 */
function hasTargetDirOption(cmd: string, args: BashToken[]): boolean {
...
export function pushCommandOps(ops: BashOp[], cmd: string, args: BashToken[], cwd: string): void {
