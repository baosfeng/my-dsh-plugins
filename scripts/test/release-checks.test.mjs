...
// ── checkClientExternals（issue #294：防 #290/#293 复发）───────────────────
...
describe('checkClientExternals', () => {
  ...
  const published = () => true
  const tagged = () => true
  /** 构造插件 package.json（只关心 dsh.client.external / dependencies / peerDependencies）。 */
  ...
  it('合法：仓库内包在 dependencies 且已发布 + 已打 tag → 空', () => {
  ...
  it('反例：仓库内包仅声明在 peerDependencies（不满足 dependencies）→ 阻断（#290/#293 的真实形态）', () => {
  ...
  it('修法文案给全三条（dependencies + 降级路径 + 踩坑文档），供 release.mjs 打印', () => {
